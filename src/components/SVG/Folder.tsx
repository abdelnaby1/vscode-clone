...
const FolderIcon = () => {
  return (
    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" {...svgStyles}  
    viewBox="0 0 347.479 347.479">
      <g>
        <path fill="#E0B03B"  d="M292.251,79.766H103.644v-8.544c0-5.974-4.888-10.862-10.862-10.862H30.414
        ...
        <rect fill="#FFFFFF;" x="23.243" y="95.385"  width="262.059" height="176.113"/>
        <path fill="#FFC843"  d="M312.426,271.293c-2.135,8.704-11.213,15.825-20.175,15.825H16.293
